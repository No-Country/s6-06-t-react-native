...
const getUser=(req,res)=>{
  ...
  try {
    ...
    const user = User.findById(uid).populate("favorites")//Añadir populate de job una vex definido


    if(!user) return response.error(req,res,"There is a problem with de provided uid",400)
