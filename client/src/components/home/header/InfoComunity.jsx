    ...
    <View style={styles.typeComunity}>
      ...
      <View style={styles.imgsUsers}>
        <Image
          ...
          style={[styles.imgUserComunity, { top: 0, left: 0 }]}
        />
        <Image
          source={require("../../../../assets/users.jpeg")}
          style={[styles.imgUserComunity, { top: 0, left: 40 }]}
        />
        <Image
          source={require("../../../../assets/users.jpeg")}
          style={[styles.imgUserComunity, { top: 0, left: 20 }]}
        />
        <Image
          source={require("../../../../assets/users.jpeg")}
          style={[styles.imgUserComunity, { top: 0, left: 60 }]}
        />
        <Text style={[styles.bundleTotalUsers, { top: 0, left: 80 }]}>
          +500
        </Text>
