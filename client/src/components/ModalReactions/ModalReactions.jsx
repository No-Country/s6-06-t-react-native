...
const ModalReactions = ({status, setShow, Show, setReaction, reaction, idPost, token}) => {
    ...
    return (
        <View style={styles.centeredView}>
            <TouchableWithoutFeedback onPressIn={()=> typeReaction(reaction, 'hacergracia')} >
                <Image source={icons.smile} style={{width:25, height:25, marginEnd : 10}}/>
            </TouchableWithoutFeedback>
            <TouchableWithoutFeedback onPress={()=> typeReaction(reaction, 'megusta')}  >
                <Image source={icons.heart} style={{width:25, height:25, marginEnd : 10}}/>

            </TouchableWithoutFeedback>
            <TouchableWithoutFeedback onPress={()=> typeReaction(reaction, 'apoyar')}  >
            ...
            <TouchableWithoutFeedback onPress={()=> typeReaction(reaction, 'meinteresa')}  >
